            ...
            <div class="offcanvas-body">
                ...
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(request()->is('formulaire*') ? 'active' : ''); ?>" href="<?php echo e(route('calendar')); ?>">
...
</div><?php /**PATH /home/aina-ny-antsa/Documents/FIANARANA/Semestre6/EVALUATION/Ev-02/new-app-laravel/resources/views/partials/sidebar.blade.php ENDPATH**/ ?>